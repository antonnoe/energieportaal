...
export const stap5Fields: FieldDef[] = [
  ...
  },
  {
    ...
    max: 1.0,
    unit: '€/kWh',
    helpText: 'Uw elektriciteitstarief per kWh.',
    defaultValue: 0.25,
    step: 5,
  },
  {
    ...
    max: 1.0,
    unit: '€/kWh',
    helpText: 'Uw stookolietarief per kWh (mazout).',
    defaultValue: 0.14,
    step: 5,
  },
  {
    ...
    max: 0.5,
    unit: '€/kWh',
    helpText: 'Uw hout-/pelletprijs per kWh.',
    defaultValue: 0.06,
    step: 5,
  },
  {
    ...
    max: 0.5,
    unit: '€/kWh',
    helpText: 'Tarief voor teruglevering van zonnestroom aan het net.',
    defaultValue: 0.06,
    step: 5,
  },
];

// ─── Backward-compatible: snelAdviesFields (voor bestaande UI) ───────────────
...
export const snelAdviesFields: FieldDef[] = [
  ...
  },
  {
    ...
    type: 'select',
    required: false,
    helpText: 'Tegemoetkomingen (zoals MaPrimeRénov\' of CEE) kunnen uw renovatiekosten aanzienlijk verlagen.',
